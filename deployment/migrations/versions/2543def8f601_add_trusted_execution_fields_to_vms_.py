...
def upgrade() -> None:
    ...
    op.add_column('vms', sa.Column('environment_trusted_execution_policy', sa.Integer(), nullable=True))
    op.add_column('vms', sa.Column('environment_trusted_execution_firmware', sa.String(), nullable=True))
