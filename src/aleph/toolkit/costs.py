...
from aleph.toolkit.constants import (
    PRICE_PRECISION,
    STORE_AND_PROGRAM_COST_DEADLINE_HEIGHT,
...
def are_store_and_program_free(message: MessageDb) -> bool:
    ...
    if height is not None:
        return height < STORE_AND_PROGRAM_COST_DEADLINE_HEIGHT
    else:
        return date < timestamp_to_datetime(STORE_AND_PROGRAM_COST_DEADLINE_TIMESTAMP)
