...
def sample_messages(session_factory):
    ...
    program_message = MessageDb(
        ...
        content={
            ...
            "code": {"ref": "code_ref", "encoding": "zip", "entrypoint": "main:app", "use_latest": True},
...
class TestRecalculateMessageCosts:
    ...
    async def test_recalculate_all_messages_empty_db(self, mock_get_session, session_factory, mock_request_factory):
    ...
    async def test_recalculate_specific_message(self, mock_get_executable, mock_get_session, session_factory, sample_messages, mock_request_factory):
    ...
    @patch('aleph.web.controllers.prices.get_session_factory_from_request')
    async def test_recalculate_all_messages_with_timeline(self, mock_get_session, session_factory, sample_messages, pricing_updates_with_timeline, existing_costs, mock_request_factory):
    ...
    @patch('aleph.web.controllers.prices.get_session_factory_from_request')
    async def test_recalculate_with_pricing_timeline_application(self, mock_get_session, session_factory, sample_messages, pricing_updates_with_timeline, mock_request_factory):
        ...
        with patch('aleph.web.controllers.prices.get_detailed_costs', side_effect=mock_get_costs):
            response = await recalculate_message_costs(request)
    ...
    @patch('aleph.web.controllers.prices.get_session_factory_from_request')
    async def test_recalculate_with_errors(self, mock_get_session, session_factory, sample_messages, mock_request_factory):
        ...
        with patch('aleph.web.controllers.prices.get_detailed_costs', side_effect=mock_get_costs_with_error):
            response = await recalculate_message_costs(request)
    ...
    @patch('aleph.web.controllers.prices.get_session_factory_from_request')
    @patch('aleph.web.controllers.prices.get_executable_message')
    async def test_recalculate_specific_message_not_found(self, mock_get_executable, mock_get_session, session_factory, mock_request_factory):
    ...
    @patch('aleph.web.controllers.prices.get_session_factory_from_request')
    async def test_chronological_processing_order(self, mock_get_session, session_factory, sample_messages, mock_request_factory):
...
class TestPricingTimelineIntegration:
    ...
    @patch('aleph.web.controllers.prices.get_session_factory_from_request')
    async def test_end_to_end_historical_pricing(self, mock_get_session, session_factory, sample_messages, pricing_updates_with_timeline, mock_request_factory):
        ...
        def mock_get_costs(session, content, item_hash, pricing):
            if pricing and hasattr(pricing, 'price'):
                if hasattr(pricing.price, 'storage') and hasattr(pricing.price.storage, 'holding'):
