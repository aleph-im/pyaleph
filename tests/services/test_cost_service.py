...
def test_compute_cost_mixed_tier_gpu(
    ...
    with session_factory() as session:
        ...
        premium_cost = next(ec for ec in execution_costs if ec.name == "instance_gpu_premium")
        standard_cost = next(ec for ec in execution_costs if ec.name == "instance_gpu_standard")
